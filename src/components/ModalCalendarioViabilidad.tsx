...
interface ModalCalendarioProps {
    ...
    onClose: () => void;
    viabilidades: any[];
    onAbrirProyecto: (viabilidad: any) => void;
}

const mesesNombres = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];

export default function ModalCalendarioViabilidad({ isOpen, onClose, viabilidades, onAbrirProyecto }: ModalCalendarioProps) {
    ...
    // Filtrar viabilidades que tengan un agendamiento
    const eventosCalendario = useMemo(() => {
        const agendados: any[] = [];
        viabilidades.forEach(v => {
