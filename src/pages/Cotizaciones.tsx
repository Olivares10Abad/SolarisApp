...
export default function Cotizaciones() {
  ...
  const handleAprobar = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await enviarNotificacionRoles('notif_revision', `Proyecto listo para revisión: ${proyectoSeleccionado.nombre_proyecto}|||/revision?proyecto_id=${proyectoSeleccionado.id}`, usuarioLogueado?.id);
